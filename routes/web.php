...
Route::group(['namespace' => 'App\Http\Controllers'], function () {
    ...
    Route::get('admission/{id}/view', ['as' => 'mamce.admission_enquiry_view', 'uses' => 'AdmissionController@admissionEnquiryView']);
    Route::get('contact-list', ['as' => 'mamce.contact_enquiry_list', 'uses' => 'ContactController@contactEnquiryList']);
    Route::get('contact/{id}/view', ['as' => 'mamce.contact_enquiry_view', 'uses' => 'ContactController@contactEnquiryView']);
...
Route::group(array('namespace' => 'App\Http\Controllers'), function () {
    ...
    Route::post('/payment-success', array('as' => 'payment-success', 'uses' => 'PaymentGatewayController@PaymentSuccess'));
