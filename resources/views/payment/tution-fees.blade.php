        ...
        <div class="dep-banner">
            <div class="py-lg-10 py-md-8 py-6 position-relative">
                ...
                <div class="position-absolute">
                    <h2 class="text-white text-center fw-bolder">Tution Fees</h2>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <form id="tution-fees-form" method="POST" action="{{route('payment-submit')}}">
                        ...
                        <div class="mb-4">
                            <input style="border: 2px solid #dfcfc1;" type="text" name="pay_for" class="form-control py-3"
                                placeholder="pay for" required readonly value="Tution Fees">
                        </div>
                        <div class="mb-4">
                            <input style="border: 2px solid #dfcfc1;" type="number" name="amount" class="form-control py-3"
                                placeholder="Amount" required>
                        </div>
                        <button type="submit" class="btn px-4 py-2" style="color: #fff; background-color: #9d7651;">Pay
                            Now</button>
                    </form>
                </div>
