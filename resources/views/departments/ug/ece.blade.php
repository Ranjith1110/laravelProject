                ...
                <div class="row">
                    ...
                    <div class="col-md-10 p-4">
                        ...
                        <div id="speciality" class="content-section d-none">
                            ...
                            <ul class="text-black">
                                <li>Centre of Excellence in IOT</li>
                                <li>Centre of Excellence in AR</li>
                                <li>RF Testing Lab</li>
                                <li>IIT Bombay E-Yantra Robotics Lab</li>
                            </ul>
                        </div>
                        ...
                        <div id="contact-us" class="content-section d-none">
                            ...
                            <p class="text-black">W.StanleyKarunagaran</p>
                            <p class="text-black">9944562640</p>
                        </div>
