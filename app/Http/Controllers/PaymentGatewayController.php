...
class PaymentGatewayController extends Controller
{
    ...
    function eazypayu_aes128Encrypt($plaintext,$key){
        ...
        // Perform encryption (no IV required for ECB mode)
        $ciphertext = openssl_encrypt($plaintext, $cipher, $key, OPENSSL_RAW_DATA);
    //dd(base64_encode($ciphertext));
        // Return Base64-encoded ciphertext for safe transmission
    ...
    public function PaymentSuccess(){
        ...
        $reference_no=$_SESSION['reference_no'];
            ...
            }elseif ($res['Response_Code']=='E00329') 
            {
                ...
                ->where('ReferenceNo', $reference_no)  // find your user by reference number
        ...
        $user = DB::table('all_icici_payments')->where('ReferenceNo', $reference_no)->first();
